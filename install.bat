...
:: 2. Erstelle ein temporaeres VBScript, das den Textblock unzerstoerbar und ohne OneDrive-Blockaden ersetzt
(
...
echo     newLines = " config_lines[330]: ""mix dsteerleft `keyboard.a?0`""" ^& vbCrLf ^& _
echo                " config_lines[331]: ""mix dsteerright `keyboard.d?0`""" ^& vbCrLf ^& _
echo                " config_lines[332]: ""mix dsteering `(keyboard.a?0 - keyboard.d?0) * (0.35 + keyboard.space?0 * 0.65)`""" ^& vbCrLf ^& _
echo                " config_lines[333]: ""mix steering `dsteering`""" ^& vbCrLf ^& _
echo                " config_lines[334]: ""mix msteering `-mouse.rel_position.x?0 * c_msens`""" ^& vbCrLf ^& _
echo                " config_lines[335]: ""mix mpedals `-mouse.rel_position.y?0 * c_msens`""" ^& vbCrLf ^& _
echo                " config_lines[336]: ""mix dforward `0`""" ^& vbCrLf ^& _
echo                " config_lines[337]: ""mix dbackward `0`""" ^& vbCrLf ^& _
echo                " config_lines[338]: ""mix aforward `(keyboard.w?0 * 0.35) + (keyboard.lalt?0 * 0.55)`""" ^& vbCrLf ^& _
echo                " config_lines[339]: ""mix abackward `keyboard.s?0 * (0.10 + keyboard.space?0 * 0.50)`""" ^& vbCrLf ^& _
echo                " config_lines[340]: ""mix forward `aforward`""" ^& vbCrLf ^& _
...
echo     Else
echo         WScript.Echo "  -> [ERROR] Target lines not found in this profile."
echo     End If
